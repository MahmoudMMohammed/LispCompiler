...
public class LispLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LINE_COMMENT", "COMMENT", "WHITESPACE", "NEW_LINE", "LPAREN", "RPAREN", 
			"QUOTE", "BACKSLASH", "DIRECTIVE_NEWLINE", "DIRECTIVE_OBJECT", "DIRECTIVE_INTEGER", 
			"DIRECTIVE_LITERAL_TILDE", "DIRECTIVE_COND_NEWLINE", "DIRECTIVE_JUSTIFY_START", 
			"DIRECTIVE_JUSTIFY_END", "DIRECTIVE_AESTHETIC", "DIRECTIVE_TABULATION", 
			"DIRECTIVE_ROMAN", "DIRECTIVE_FIXED", "DIRECTIVE_EXPONENTIAL", "DIRECTIVE_GENERAL", 
			"DIRECTIVE_PLURALIZE", "DIRECTIVE_CHARACTER", "DIRECTIVE_CONDITIONAL", 
			"STRING_WITH_DIRECTIVES", "STRING", "NUMBER", "ADDITION", "SUBTRACTION", 
			"MULTIPLICATION", "DIVISION", "LESS_THAN", "LESS_EQUAL", "GREATER_THAN", 
			"GREATER_EQUAL", "EQUALS", "NOT_EQUAL", "UNDERSCORE", "DIGIT", "LETTER", 
			"ESC_SEQ", "DEFUN", "SETQ", "LET", "IF", "EXP", "EXPT", "LAMBDA", "PROGN", 
			"LOOP", "RETURN", "COND", "EVENP", "ODDP", "CASE", "OTHERWISE", "AND", 
			"OR", "NOT", "QUOTEQ", "DEFVAR", "DEFPARAMETER", "DEFMACRO", "FUNCTION", 
			"MAPCAR", "APPLY", "FUNCALL", "EVAL", "LOAD", "PRINT", "READ", "FORMAT", 
			"CONS", "CAR", "CDR", "LIST", "APPEND", "LENGTH", "REVERSE", "MEMBER", 
			"ASSOC", "REMOVE", "FIND", "POSITION", "SUBSTRING", "CONCATENATE", "CHAR", 
			"AREF", "SORT", "MERGE", "SUBSETP", "REDUCE", "FILTER", "EVERY", "SOME", 
			"NULL", "TYPEOF", "EQUAL", "EQ", "EQL", "EQUALP", "TYPEP", "SUBTYPEP", 
			"COERCE", "DECLARE", "THE", "BLOCK", "RETURN_FROM", "CATCH", "THROW", 
			"TAGBODY", "GO", "DEFCLASS", "DEFMETHOD", "DEFGENERIC", "INTERSECTION", 
			"UNION", "SET_DIFFERENCE", "SIGNAL", "ERROR", "WARN", "BREAK", "CONTINUE", 
			"STORE_VALUE", "USE_VALUE", "ABORT", "TYPECASE", "ETYPECASE", "CTYPECASE", 
			"PROG", "PROG1", "PROG2", "DO", "DOLIST", "DOTIMES", "NEXT_METHOD_P", 
			"WHEN", "UNLESS", "NIL", "T", "PUSH", "POP", "FACT", "OPTIONAL", "RESET", 
			"KEY", "MAKE_ARRAY", "DEFSTRUCT", "SETF", "INCF", "STAR2", "STAR3", "SYMBOL", 
			"UNEXPECTED_CHAR"
		};
	}
	...
	private void UNEXPECTED_CHAR_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 0:
			System.err.println("Lexical error at line " + getLine() + ":" + getCharPositionInLine() + " - unrecognized character: " + getText());
			break;
		}
	}
